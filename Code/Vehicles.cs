	...
	var cannonball = AssetManager.terraform.get("cannonball");
		cannonball.applies_to_high_flyers = false;
          ...
          AssetManager.projectiles.add(iceshell);
            ...
            modernCapMissileBlast.transform_to_wasteland = false;
            modernCapMissileBlast.explode_tile = false;
            modernCapMissileBlast.damage_buildings = true;
            modernCapMissileBlast.destroy_buildings = true;
...
var AntiAirbomb = AssetManager.terraform.clone("AntiAirbomb", "grenade");
        ...
        AssetManager.terraform.add(AntiAirbomb);
			...
			jetrocketprojectile.terraform_option = "modern_cap_missile_blast";
			jetrocketprojectile.terraform_range = 4;
          ...
          AssetManager.projectiles.add(jetrocketprojectile);
			...
			jetrocketprojectileHorde.terraform_option = "modern_cap_missile_blast";
			jetrocketprojectileHorde.terraform_range = 4;
          ...
          AssetManager.projectiles.add(jetrocketprojectileHorde);
			...
			jetrocketprojectileHarden.terraform_option = "modern_cap_missile_blast";
			jetrocketprojectileHarden.terraform_range = 4;
          ...
          AssetManager.projectiles.add(jetrocketprojectileHarden);
			...
			jetrocketprojectileGaia.terraform_option = "modern_cap_missile_blast";
			jetrocketprojectileGaia.terraform_range = 4;
          ...
          AssetManager.projectiles.add(jetrocketprojectileGaia);
			...
			bigbomb.terraform_option = "modern_cap_missile_blast";
			bigbomb.terraform_range = 4;
          ...
          AssetManager.projectiles.add(bigbomb);
            ...
            bomberrocketprojectile.terraform_option = "modern_cap_missile_blast";
			...
			bigbombGaia.terraform_option = "modern_cap_missile_blast";
			bigbombGaia.terraform_range = 4;
          ...
          AssetManager.projectiles.add(bigbombGaia);
			...
			bigbombHarden.terraform_option = "modern_cap_missile_blast";
			bigbombHarden.terraform_range = 4;
          ...
          AssetManager.projectiles.add(bigbombHarden);
			...
			bigbombHorde.terraform_option = "modern_cap_missile_blast";
			bigbombHorde.terraform_range = 4;
...
var Transporter_alliance = AssetManager.actor_library.clone("Transporter_alliance","$boat$");
		...
		Transporter_alliance.is_boat_transport = true;
...
aDestroyer_alliance.inspect_avatar_offset_y = 6f;
		...
		aDestroyer_alliance.is_boat_transport = true;
...
bDestroyer_alliance.inspect_avatar_offset_y = 6f;
		...
		bDestroyer_alliance.is_boat_transport = true;
...
Submarine_alliance.inspect_avatar_offset_y = 6f;
	...
	var Transporter_horde = AssetManager.actor_library.clone("Transporter_horde","$boat$");
		...
		Transporter_horde.is_boat_transport = true;
...
aDestroyer_horde.inspect_avatar_offset_y = 6f;
		...
		aDestroyer_horde.is_boat_transport = true;
...
bDestroyer_horde.inspect_avatar_offset_y = 6f;
		...
		bDestroyer_horde.is_boat_transport = true;
...
Submarine_horde.inspect_avatar_offset_y = 6f;
	...
	var Transporter_gaia = AssetManager.actor_library.clone("Transporter_gaia","$boat$");
		...
		Transporter_gaia.is_boat_transport = true;
...
aDestroyer_gaia.inspect_avatar_offset_y = 6f;
		...
		aDestroyer_gaia.is_boat_transport = true;
...
bDestroyer_gaia.inspect_avatar_offset_y = 6f;
		...
		bDestroyer_gaia.is_boat_transport = true;
...
Submarine_gaia.inspect_avatar_offset_y = 6f;
	...
	var Transporter_harden = AssetManager.actor_library.clone("Transporter_harden","$boat$");
		...
		Transporter_harden.is_boat_transport = true;
...
aDestroyer_harden.inspect_avatar_offset_y = 6f;
		...
		aDestroyer_harden.is_boat_transport = true;
...
bDestroyer_harden.inspect_avatar_offset_y = 6f;
		...
		bDestroyer_harden.is_boat_transport = true;
...
string[] unitNames = new string[]
{
    ...
    "shermanww", "tankie", "genericwwtank", "landship", "bigtankww", "davincitank", "batteringram",
    "Tank_Ork", "MissileSystem_Ork", "wheeledtank_Ork",
    "Tank_Dwarf", "MissileSystem_Dwarf", "wheeledtank_Dwarf", "santaguin",
