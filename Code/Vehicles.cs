	...
	var cannonball = AssetManager.terraform.get("cannonball");
		cannonball.applies_to_high_flyers = false;
          ...
          AssetManager.projectiles.add(iceshell);
            ...
            modernCapMissileTrail.limit = 50;
			...
			missileartillery.sound_impact = "event:/SFX/EXPLOSIONS/ExplosionSmall";
			...
			missileartillery.trail_effect_timer = 0.1f;
          ...
          AssetManager.projectiles.add(missileartillery);
			...
			fireboneartillery.sound_impact = "event:/SFX/EXPLOSIONS/ExplosionSmall";
			...
			fireboneartillery.trail_effect_timer = 0.1f;
          ...
          AssetManager.projectiles.add(fireboneartillery);
			...
			frostmissileartillery.sound_impact = "event:/SFX/EXPLOSIONS/ExplosionSmall";
			...
			frostmissileartillery.trail_effect_timer = 0.1f;
          ...
          AssetManager.projectiles.add(frostmissileartillery);
			...
			plantmissileartillery.sound_impact = "event:/SFX/EXPLOSIONS/ExplosionSmall";
			...
			plantmissileartillery.trail_effect_timer = 0.1f;
