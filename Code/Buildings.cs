...
namespace ModernBox
{
    class Buildings : MonoBehaviour
    {
        ...
        public static void init()
        {
            ...
            UnifiedNavalProduction.EnableAllDocks();
        }
...
bonfire_modern_alliance.upgrade_to = string.Empty;
...
House_modern_alliance.upgrade_to = string.Empty;
...
bonfire_modern_harden.upgrade_to = string.Empty;
...
House_modern_harden.upgrade_to = string.Empty;
...
bonfire_modern_gaia.upgrade_to = string.Empty;
...
House_modern_gaia.upgrade_to = string.Empty;
...
string[] hordecivs = new string[] { "orc", "necromancer", "civ_fox", "civ_wolf", "civ_bear", "civ_hyena", "civ_rat", "civ_scorpion", "civ_crocodile", "civ_snake", "civ_piranha", "greg", "jumpy_skull" };
    ...
    bonfire_modern_horde.upgrade_to = string.Empty;
    ...
    House_modern_horde.upgrade_to = string.Empty;
...
public static class EvolutionPatches
{
    ...
    {
        // Preserve WorldBox's native cultural build-order template.  Replacing it
        // with the epoch template bypassed the normal medieval house progression.
    }
}
 ...
 [HarmonyPatch(typeof(Docks), "buildBoatFromHere")]
        public static class Patch_Docks_BuildBoatFromHere
        {
            static bool Prefix(Docks __instance, City pCity, ref Actor __result)
            {
                ...
                {
                    // The unified path owns every dock. Falling through to the
                    // legacy selector would restore cheap era-specific ships.
                    __result = null;
                    return false;
                }
        ...
        public static class Patch_BuildingAsset_GetRandomBoatAssetToBuild
        {
            static bool Prefix(BuildingAsset __instance, City pCity, ref ActorAsset __result)
            {
                ...
                if (UnifiedNavalProduction.ShouldReplace(__instance, pCity))
                {
                    ActorAsset selected = UnifiedNavalProduction.SelectAffordableAsset(__instance, pCity);
                    if (selected != null)
                    {
                        __result = selected;
                        return false;
